...
const resetpasswordemail_post = async (req, res, next) => {
  ...
  const data = {
    ...
    html: `<a href="https://gamingplatformtesting.netlify.app/resetpassword/${token}">https://gamingplatformtesting.netlify.app/resetpassword/${token}</a>
  ...
  if (findOrder.mailSent === false) {
    ...
    const data = {
      ...
      html: `<br>Thank you, Your order was placed successfully and we will prepare your package right away<br>
         ...
         <a href="https://gamingplatformtesting.netlify.app/collections">https://gamingplatformtesting.netlify.app/collections</a>
         <br><br>
