...
const resetpasswordemail_post = async (req, res, next) => {
  ...
  const data = {
    ...
    html: `<a href="https://gaming-platform-frontend-nextjs-czaz.vercel.app/resetpassword/${token}">https://gaming-platform-frontend-nextjs-czaz.vercel.app/resetpassword/${token}</a>
  ...
  if (findOrder.mailSent === false) {
    ...
    const data = {
      ...
      html: `<br>Thank you, Your order was placed successfully and we will prepare your package right away<br>
         ...
         <a href="https://gaming-platform-frontend-nextjs-czaz.vercel.app/collections">https://gaming-platform-frontend-nextjs-czaz.vercel.app/collections</a>
         <br><br>
