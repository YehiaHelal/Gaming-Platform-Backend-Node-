...
const resetpasswordemail_post = async (req, res, next) => {
  ...
  const data = {
    ...
    html: `<a href="https://pharma-online-frontend.vercel.app/resetpassword/${token}">https://pharma-online-frontend.vercel.app/resetpassword/${token}</a>
  ...
  if (findOrder.mailSent === false) {
    ...
    const data = {
      ...
      html: `<br>Thank you, Your order was placed successfully and we will prepare your package right away<br>
         ...
         <a href="https://pharma-online-frontend.vercel.app/collections">https://pharma-online-frontend.vercel.app/collections</a>
         <br><br>
